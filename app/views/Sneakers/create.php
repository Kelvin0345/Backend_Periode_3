        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SneakersController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="type" type="text" class="form-control" id="model" value="<?= $_POST['type'] ?? ''; ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input name="materiaal" type="tekst" class="form-control" id="materiaal" value="<?= $_POST['materiaal'] ?? ''; ?>" required>
                </div>

                <div class="mb-3">
                    <label for="gewicht" class="form-label">Gewicht</label>
                    <input name="gewicht" type="text" class="form-control" id="gewicht" value="<?= $_POST['gewicht'] ?? ''; ?>" required>
                </div>
