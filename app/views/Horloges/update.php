        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogesController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" max="10000" class="form-control" id="gewicht" value="<?= $_POST['gewicht'] ?? $data['horloge']->Gewicht ?>">
                </div>
                ...
                <div class="mb-3">
                    <label for="waterdichtheid" class="form-label">Waterdichtheid (ATM/Meters)</label>
                ...
                <div class="mb-3">
                    <label for="horlogetype" class="form-label">Horloge Type</label>
                    <input name="horlogetype" type="text" class="form-control" id="horlogetype" value="<?= $_POST['horlogetype'] ?? $data['horloge']->HorlogeType ?>" required>
                </div>
            ...
            <div class="mt-3">
                <a href="<?= URLROOT; ?>/HorlogesController/index"><i class="bi bi-arrow-left"></i> Terug naar overzicht</a>
            </div>
        </div>
    </div>
</div>  
